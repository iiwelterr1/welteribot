...
module.exports = {
  ...
  execute(message) {
    ...
    let nowPlaying = new MessageEmbed()
      .setTitle("تشتغل الحين")
      .setDescription(`${song.title}\n${song.url}`)
      .setColor("#F8AA2A")
      .setAuthor("Welter Bot")
    ...
    if (song.duration > 0) nowPlaying.setFooter("الوقت : " + new Date(left * 1000).toISOString().substr(11, 8));
